...
export function DiagnosisCard({ data }: DiagnosisCardProps) {
  return (
    <div className="rounded-2xl border bg-card/70 p-8 shadow-sm">
      <div
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <span className="text-lg font-mono text-foreground">{data.patient_id}</span>
          </div>
          
          <div className="flex items-start space-x-4">
            <span className="text-base font-semibold text-muted-foreground">病症：</span>
            <span className="text-lg text-foreground flex-1">{data.diagnosis}</span>
          </div>
